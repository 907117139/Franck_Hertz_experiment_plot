...
p = figure(title="LaTex Demonstration", plot_width=600, plot_height=600, min_border_left = 80, min_border_bottom = 80)
p.line(x, y)

# Note: must set ``render_mode="css"``
latex = LatexLabel(text="V_{G2K}/V",x=390, y=15,
                    x_units='screen', y_units='screen',
                   render_mode='css', text_font_size='10pt')

latex2 = LatexLabel(text="I_A/{\mu}A",
                   x=1, y=500, x_units='screen', y_units='screen',
                   render_mode='css', text_font_size='10pt')
p.add_layout(latex, 'below')
p.add_layout(latex2, 'left')
